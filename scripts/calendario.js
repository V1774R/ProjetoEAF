...
function resumir(){
    ...
    elemento.innerHTML += `<div class="btn" style="cursor: pointer;"><a href="php/confirmacao.php?nome=${nome}&cpf=${cpf}&telefone=${telefone}&dia=${dia}&mes=${mes}&hora=${hora}" style="text-decoration: none; color: white;">Confirmar</a></div><br>`;
}